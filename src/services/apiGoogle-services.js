...
exports.getDate = (timeMin = minDate, timeMax = maxDate)=> {
    ...
    return fetch(`${url}?calendarId=hilares33v%40gmail.com&singleEvents=true&timeZone=America%2FLima&maxAttendees=1&maxResults=250&sanitizeHtml=true&orderBy=startTime&timeMin=${timeMin}T00%3A00%3A00-05%3A00&timeMax=${timeMax}T00%3A00%3A00-05%3A00&key=AIzaSyBNlYH01_9Hc5S1J9vuFmu2nUqBZJNAXxs`)
